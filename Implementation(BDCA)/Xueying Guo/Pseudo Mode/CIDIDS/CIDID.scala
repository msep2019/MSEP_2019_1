//This is SVM for other Datasets, not for CrossValidation
...
object SVM_CrossV {
    ...
    println("------------------------Read File-------------------------")
    val traindata = sc.textFile("/home/hadoop/Desktop/svm/CIDIDS/20CIDIDSTrain.txt")   
    val testdata = sc.textFile("/home/hadoop/Desktop/svm/CIDIDS/20CIDIDSTest.txt")
    ...
    val training = traindata.map { line =>
      val parts = line.split(',')
        LabeledPoint(
            parts(11).toDouble,
            Vectors.dense(
                if ( parts(0) == "EXTSERVER") 99999.toDouble
                else parts(0).toDouble,
                if ( parts(1) == "EXTSERVER") 99999.toDouble
                else parts(1).toDouble,
                if ( parts(2) == "EXTSERVER") 99999.toDouble
                else parts(2).toDouble,
                if ( parts(3) == "EXTSERVER") 99999.toDouble
                else parts(3).toDouble,
                if ( parts(4) == "EXTSERVER") 99999.toDouble
                else parts(4).toDouble,
                if ( parts(5) == "EXTSERVER") 99999.toDouble
                else parts(5).toDouble,
                if ( parts(6) == "EXTSERVER") 99999.toDouble
                else parts(6).toDouble,
                if ( parts(7) == "EXTSERVER") 99999.toDouble
                else parts(7).toDouble,
                if ( parts(8) == "EXTSERVER") 99999.toDouble
                else parts(8).toDouble,
