...
libraryDependencies += "org.apache.spark" % "spark-mllib_2.11" % "2.4.2"

libraryDependencies += "org.apache.spark" % "spark-mllib-local_2.11" % "2.4.2"
...
libraryDependencies += "com.twitter" % "chill_2.11" % "0.9.3"
...
libraryDependencies += "com.fasterxml.jackson.module" % "jackson-module-scala_2.11" % "2.6.7.1"
...
libraryDependencies += "org.json4s" % "json4s-ast_2.11" % "3.5.3"
	
libraryDependencies += "org.json4s" % "json4s-core_2.11" % "3.5.3"
	
libraryDependencies += "org.json4s" % "json4s-jackson_2.11" % "3.5.3"
	
libraryDependencies += "org.json4s" % "json4s-scalap_2.11" % "3.5.3"
...
libraryDependencies += "org.typelevel" % "machinist_2.11" % "0.6.1"
	
libraryDependencies += "org.typelevel" % "macro-compat_2.11" % "1.1.1"
...
libraryDependencies += "org.apache.spark" % "spark-catalyst_2.11" % "2.4.2"
	
libraryDependencies += "org.apache.spark" % "spark-graphx_2.11" % "2.4.2"
	
libraryDependencies += "org.apache.spark" % "spark-kubernetes_2.11" % "2.4.2"
	
libraryDependencies += "org.apache.spark" % "spark-kvstore_2.11" % "2.4.2"
	
libraryDependencies += "org.apache.spark" % "spark-launcher_2.11" % "2.4.2"
	
libraryDependencies += "org.apache.spark" % "spark-mesos_2.11" % "2.4.2"
	
libraryDependencies += "org.apache.spark" % "spark-network-common_2.11" % "2.4.2"
	
libraryDependencies += "org.apache.spark" % "spark-network-shuffle_2.11" % "2.4.2"
	
libraryDependencies += "org.apache.spark" % "spark-repl_2.11" % "2.4.2"
	
libraryDependencies += "org.apache.spark" % "spark-sketch_2.11" % "2.4.2"
	
libraryDependencies += "org.apache.spark" % "spark-sql_2.11" % "2.4.2"
	
libraryDependencies += "org.apache.spark" % "spark-streaming_2.11" % "2.4.2"
	
libraryDependencies += "org.apache.spark" % "spark-tags_2.11" % "2.4.2"
	
libraryDependencies += "org.apache.spark" % "spark-unsafe_2.11" % "2.4.2"
	
libraryDependencies += "org.apache.spark" % "spark-yarn_2.11" % "2.4.2"
...
libraryDependencies += "org.scalanlp" % "breeze-macros_2.11" % "0.13.2"
