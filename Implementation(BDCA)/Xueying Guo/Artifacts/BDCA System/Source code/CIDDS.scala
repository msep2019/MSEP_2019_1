...
object CIDIDS {
    ...
    //val conf = new SparkConf().setAppName("TestSVM").setMaster("local")
    val conf = new SparkConf().setAppName("CIDIDS")
    val sc = new SparkContext(conf)

    println("------------------------Read File-------------------------")
    val traindata = sc.textFile("/user/ubuntu/spark/CIDIDS/CIDIDSTrain.txt")   
    val testdata = sc.textFile("/user/ubuntu/spark/CIDIDS/CIDIDSTest.txt")
