...
//			String uri = "hdfs://master:9000";			// Run on cluster mode
			...
			String train_dataName = "/user/hadoop/nb/nb15/train/NB15_train.csv";
			String test_dataName = "/user/hadoop/nb/nb15/test/NB15_test.csv";
			String train_datasetName = "/user/hadoop/rf/nb15/train/descriptor.info";
			String modelName = "/user/hadoop/rf/nb15/output";
			String prediction_file = "/user/hadoop/rf/nb15/prediction";
