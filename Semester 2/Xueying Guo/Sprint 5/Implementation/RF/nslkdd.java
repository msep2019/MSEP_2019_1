...
//			String uri = "hdfs://master:9000";			// Run on cluster mode
			...
			String train_dataName = "/user/hadoop/nb/nslkdd/train/NSLKDDTrain.txt";
			String test_dataName = "/user/hadoop/nb/nslkdd/test/NSLKDDTest.txt";
			String train_datasetName = "/user/hadoop/rf/nslkdd/train/descriptor.info";
			String modelName = "/user/hadoop/rf/nslkdd/output";
			String prediction_file = "/user/hadoop/rf/nslkdd/prediction";
