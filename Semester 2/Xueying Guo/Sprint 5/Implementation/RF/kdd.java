...
//			String uri = "hdfs://master:9000";			// Run on cluster mode
			...
			String train_dataName = "/user/hadoop/nb/kdd/train/KDDTrain.txt";
			String test_dataName = "/user/hadoop/nb/kdd/test/KDDTest.txt";
			String train_datasetName = "/user/hadoop/rf/kdd/train/descriptor.info";
			String modelName = "/user/hadoop/rf/kdd/output";
			String prediction_file = "/user/hadoop/rf/kdd/prediction";
...
//			              System.out.println("prediction " + prediction );
		            	  if ( key == 18.0 && prediction == 18.0) {
				        	  tn ++; total_test++;
				          }else if(key != 18.0 && prediction == 18.0) {
				        	  fn ++; total_test++;
				          }else if (key == 18.0 && prediction != 18.0) {
				        	  fp ++; total_test++;
				          }else if (key != 18.0 && prediction != 18.0) {
