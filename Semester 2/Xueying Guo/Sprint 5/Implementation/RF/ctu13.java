...
//			String train_dataName = "/user/hadoop/rf/ctu13/train/ctutrain_blank.csv";
			String train_dataName = "/user/hadoop/nb/ctu13/train/CTU13_train.csv";
			String test_dataName = "/user/hadoop/nb/ctu13/test/CTU13_test.csv";
			String train_datasetName = "/user/hadoop/rf/ctu13/train/descriptor.info";
			String modelName = "/user/hadoop/rf/ctu13/output";
			String prediction_file = "/user/hadoop/rf/ctu13/prediction";
...
//			String descriptor = "N N N N N N N N N N N L";
			String descriptor = "7 N 2 I 4 N L";
