...
import randomforest.random.Iot3.CMapper;

public class Iot3 {
	
	private static final Logger log = LoggerFactory.getLogger(Iot3.class);
...
*/		    String workpath = fs.getWorkingDirectory().toString();
			...
			String train_dataName = "/user/ubuntu/Hadoop/nb/Iot/train/Iot_train_76.csv";
			String test_dataName = "/user/ubuntu/Hadoop/nb/Iot/test/Iot_test76.csv";
