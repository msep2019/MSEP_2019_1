...
//			String uri = "hdfs://master:9000";			// Run on cluster mode
			...
			String train_dataName = "/user/hadoop/nb/cicids2017/train/CICIDS2017_train.csv";
			String test_dataName = "/user/hadoop/nb/cicids2017/test/CICIDS2017_test.csv";
			String train_datasetName = "/user/hadoop/rf/cicids2017/train/descriptor.info";
			String modelName = "/user/hadoop/rf/cicids2017/output";
			String prediction_file = "/user/hadoop/rf/cicids2017/prediction";
