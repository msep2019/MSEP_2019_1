...
//			String uri = "hdfs://master:9000";			// Run on cluster mode
			...
			String train_dataName = "/user/hadoop/nb/ddos2019/train/DDOS2019_train.csv";
			String test_dataName = "/user/hadoop/nb/ddos2019/test/DDOS2019_test.csv";
			String train_datasetName = "/user/hadoop/rf/ddos2019/train/descriptor.info";
			String modelName = "/user/hadoop/rf/ddos2019/output";
			String prediction_file = "/user/hadoop/rf/ddos2019/prediction";
...
//			String descriptor = "N N N N N N N N N N N L";
			String descriptor = "82 N 1 I 1 N L";
		            ...
		            for (Pair<DoubleWritable,Text> record : new SequenceFileIterable<DoubleWritable,Text>(path, true, conf)) {
		             ...
		             // String[] format=test_dataName.split(".");
		              ...
		              if (value.contains(format)) {			// this is the first value, it contains the name of the input file
		            	  ...
		            	  if(pp == 1) { System.out.println("key " + key ); System.out.println("prediction " + prediction ); pp++;}
//		            	  System.out.println("pp " + pp++ );
//		            	  System.out.println("key " + key );
//			              System.out.println("prediction " + prediction );
		            	  if ( key == 1.0 && prediction == 1.0) {
				        	  tn ++; total_test++;
				          }else if(key != 1.0 && prediction == 1.0) {
				        	  fn ++; total_test++;
				          }else if (key == 1.0 && prediction != 1.0) {
				        	  fp ++; total_test++;
				          }else if (key != 1.0 && prediction != 1.0) {
