...
//			String uri = "hdfs://master:9000";			// Run on cluster mode
			...
			String train_dataName = "/user/hadoop/nb/darpa/train/DarpaTrain.txt";
			String test_dataName = "/user/hadoop/nb/darpa/test/DarpaTest.txt";
			String train_datasetName = "/user/hadoop/rf/darpa/train/descriptor.info";
			String modelName = "/user/hadoop/rf/darpa/output";
			String prediction_file = "/user/hadoop/rf/darpa/prediction";
